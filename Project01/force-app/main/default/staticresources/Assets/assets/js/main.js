	...
	if ($elementCarousel.elExists()) {
		...
		$elementCarousel.each(function (index, element) {
			...
			var $spaceBetween = $options.spaceBetween ? parseInt($options.spaceBetween, 10) : 0,
				...
				'"></i></span>' :
				'<button class="tty-slick-text-btn tty-slick-text-prev"><i class="fas fa-chevron-left"></i></span>' :
				'',
				$nextArrow =
				$arrows === true ?
				$options.nextArrow ?
				...
				'"></i></span>' :
				'<button class="tty-slick-text-btn tty-slick-text-next"><i class="fas fa-chevron-right"></i></span>' :
				'',
